 ...
 */
final class Version20180817131723 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE author ADD email VARCHAR(255) NOT NULL, ADD is_active TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE author DROP email, DROP is_active');
    }
}
